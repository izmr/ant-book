...
// in simulator we redefine to format for antbook Developer console
...
{\
	NSString * exceptionName = [@"org.antbook." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.antbook";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIantbookNativeItemNone = -1, 
	UIantbookNativeItemSpinner = -2,
	UIantbookNativeItemProgressBar = -3,
	
	UIantbookNativeItemSlider = -4,
	UIantbookNativeItemSwitch = -5,
	UIantbookNativeItemMultiButton = -6,
	UIantbookNativeItemSegmented = -7,
	
	UIantbookNativeItemTextView = -8,
	UIantbookNativeItemTextField = -9,
	UIantbookNativeItemSearchBar = -10,
	
	UIantbookNativeItemPicker = -11,
	UIantbookNativeItemDatePicker = -12,
	
	UIantbookNativeItemInfoLight = -13,
	UIantbookNativeItemInfoDark = -14,
	
	UIantbookNativeItemDisclosure = -15,
	
	UIantbookNativeItemContactAdd = -16
};
