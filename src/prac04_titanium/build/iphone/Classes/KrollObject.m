...
//@interface antbookObject : NSObject
//@end

@interface antbookObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[antbookObject class]])
		{
			for (NSString *key in [[(antbookObject*)o modules] allKeys])
			{
