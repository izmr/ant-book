...
MAKE_SYSTEM_PROP(ACTIVITY,UIantbookNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIantbookNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIantbookNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIantbookNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIantbookNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIantbookNativeItemContactAdd);
